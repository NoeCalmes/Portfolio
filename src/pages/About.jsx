  ...
  export default function About() {
    return (
      <div className="pt-[92px] min-h-screen overflow-x-hidden">
        {/* Section “cloud” */}
        <MagneticDiv strengthX={190} strengthY={80} className="w-full flex justify-center px-20">
        ...
        <div className="w-full max-w-[600px] mt-12 mx-auto pt-7">
          <h1
            className="
              text-left
              font-semibold
          ...
          >
            ...
            <a href="https://www.linkedin.com/in/noe-calmes/" className="cursor-pointer inline-block px-[1px] shadow-[inset_0_-3px_0_0_#bdbdc5] transition-[box-shadow,color,border-radius] duration-150 ease-[cubic-bezier(.215,.61,.355,1)] hover:text-[#0e0e0f] hover:rounded-md hover:shadow-[inset_0_-40px_#e5e5e7,0_0_0_0.1px_#e5e5e7]">
              me contacter.
            </a>
          </p>
