...
<head>
    ...
    <meta name="description"
        content="Découvrez mon portfolio : Je suis Noé Calmesn développeur web passionné et curieux, toujours en quête d'amélioration">
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-RCVDDS47JE"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag() { dataLayer.push(arguments); }
        gtag('js', new Date());

        gtag('config', 'G-RCVDDS47JE');
    </script>
    <!-- Google tag (gtag.js) -->
</head>
    ...
    <article>
        <div class="container">
            <div class="article-left">
                ...
                <img class="image" src="<?= base_url('public/img/image.png'); ?>" alt="">
                ...
                <div class="reseau">
                    ...
                    <a href="https://github.com/NoeCalmes">
                        <button class="grille">
                            ...
                            <img src="<?= base_url('public/img/article-left/reseau/github.svg'); ?>" alt="">
                        </button>
                    </a>
                    ...
                    <a href="https://codepen.io/noecalmes">
                        <button class="grille">
                            <div class="round-background"></div>
                            <img src="<?= base_url('public/img/article-left/reseau/codepen.svg'); ?>" alt="">
                        </button>
                    </a>
                    ...
                    <a href="https://www.linkedin.com/in/noe-calmes-627564236/">
                        <button class="grille">
                            <div class="round-background"></div>
                            <img class="linkedin" src="<?= base_url('public/img/article-left/reseau/linkedin.svg'); ?>"
                                alt="">
                        </button>
                    </a>
                ...
                <div class="contact">
                    <div class="icon">
                        <img src="<?= base_url('public/img/article-left/Phone.svg'); ?>" alt="">
                    ...
                    <div class="icon2">
                        <img src="<?= base_url('public/img/article-left/email.svg'); ?>" alt="">
                    ...
                    <div class="icon3">
                        <img src="<?= base_url('public/img/article-left/location.svg'); ?>" alt="">
                    ...
                    <a href="<?php echo base_url('public/pdf/cv-noecalmes.pdf') ?>" target="_blank"><button
                            class="download fr">Télécharger mon CV
                            <div class="icon-1">
                    ...
                    <a href="<?php echo base_url('public/pdf/cv-noecalmes.pdf') ?>"><button class="download en"
                            style="display:none;">Download Resume
                            <div class="icon-1">
                                <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" version="1.1"
                                    style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd"
                                    viewBox="0 0 26.3 65.33" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <div class="article1">
                <div class="article-right article1">
                    <div class="about">
                        <div class="centrer-d">
                            <h1 class="dark fr">A Propos</h1>
                            <h1 class="dark en" style="display:none;">About Me</h1>
                        </div>
                        <div class="line-about"></div>
                    </div>

                    <p class="text grey fr"> Bonjour ! Je suis ravi de vous accueillir dans mon portfolio. Je suis
                        étudiant et
                        développeur passionné avec un vif pour la programmation orienté web . Ma détermination envers le
                        domaine
                        de la programmation est inébranlable, je m'efforce constamment d'améliorer mes compétences et
                        d'adopter
                        les tendances
                        émergentes de l'industrie. </p>

                    <p class="text grey en" style="display:none;">Hello ! I'm delighted to welcome you to my portfolio.
                        I am a
                        student and a passionate developer with a keen interest in exploring the latest cutting-edge
                        technologies. My journey in the world of web development is truly exciting, and I constantly
                        strive to
                    ...
                    <div class="card-desc">
                        ...
                        <div class="card">
                            <div class="align">
                                <img src="<?= base_url('public/img/article-right/index/1carde.svg'); ?>" alt="">
                            ...
                            <p class="fr">En tant que développeur, je suis captivé par la puissance et la flexibilité de
                                Javascript et PHP
                                . Je suis toujours impatient de plonger dans de nouveaux projets et de
                                découvrir des moyens innovants de créer des applications rapides et évolutives.</p>

                            <p class="en" style="display:none;">As a developer, I am captivated by the power and
                                flexibility of
                                JavaScript and PHP. I am always
                                eager to dive into new projects and explore innovative ways to create fast and scalable
                                applications.</p>
                        </div>

                        <div class="card">
                            <div class="align">
                                <img class="two" src="<?= base_url('public/img/article-right/index/ecommerce.svg'); ?>"
                                    alt="">
                                <h1 class="fr">E-commerce</h1>
                                <h1 class="en" style="display:none;">E-commerce</h1>
                            </div>
                            <p class="fr">
                                Mon projet parallèle dans le e-commerce renforce ma passion pour cet univers. En
                                perfectionnant
                                mes compétences, je vise à jouer un rôle actif dans son développement et son succès,
                                tout en
                                réalisant mes aspirations entrepreneuriales</p>
                            <p class="en" style="display:none;">My parallel project in e-commerce strengthens my passion
                                for
                                this field. By honing my skills, I aim to play an active role in its development and
                                success
                                while pursuing my entrepreneurial aspirations.</p>

                        </div>

                        <div class="card">
                            <div class="align">
                                <img src="<?= base_url('public/img/article-right/index/3carde.svg'); ?>" alt="">
                                <h1 class="fr">Conception UI/UX</h1>
                                <h1 class="en" style="display:none;">UI/UX Designing</h1>
                            </div>
                            <div class="text-p">
                                <p class="fr">Créer des interfaces utilisateur visuellement attrayantes et intuitives
                                    qui
                                    offrent une
                                    expérience
                                    utilisateur agréable est quelque chose dont je suis vraiment fanatique</p>
                                <p class="en" style="display:none;">Creating visually appealing and intuitive user
                                    interfaces
                                    that provide a delightful user experience is something I'm truly passionate about.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="align">
                                <img class="trois"
                                    src="<?= base_url('public/img/article-right/index/communication.svg'); ?>" alt="">
                                <h1>Communication</h1>
                            </div>
                            <p class="fr">Partager et apprendre sont également des sources de grande satisfaction pour
                                moi. Je
                                trouve une grande joie à partager avec les autres, et j'apprécie tout autant
                                l'opportunité
                                d'apprendre davantage . </p>
                            <p class="en" style="display:none;">Sharing and learning are also sources of great
                                satisfaction for
                                me. I derive immense joy from sharing with others, and I equally appreciate the
                                opportunity to
                                further my learning.
                            </p>
                        </div>
