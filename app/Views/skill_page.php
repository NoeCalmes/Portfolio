<?php $activePage = 'skill'; // Page active ?>
        ...
        <div class="container">
            ...
            <div class="article4">
                <div class="article-right">
                    ...
                    <div class="about">
                        <h1 class="dark fr">Compétence</h1>
                        <h1 class="dark en" style="display:none;">Skill</h1>
                        <div class="line-about"></div>
                    </div>

                    <div class="iframe-container">
                        <h2 class="dev-web fr">Mes compétences informatiques:</h2>
                        <h2 class="dev-web en " style="display:none;">My computer skills:</h2>
                        <p class="competence-titre fr">Mes expériences professionnelles m'ont permis d'acquérir une
                            certaine
                            autonomie
                            et polyvalence. Je dispose également de compétences techniques dans les domaines suivants :
                        </p>
                        <p class="competence-titre en" style="display:none;">My professional experiences have allowed me
                            to gain a
                            certain level of autonomy and versatility. I also possess technical skills in the following
                            areas:</p>
                        <div class="container-skill">
                            <div class="bloc1">
                                <p class="p-skill center-skill fr">Développement Web</p>
                                <p class="p-skill center-skill en" style="display:none;">Web development</p>
                                <div class="bloc-div1">
                                    <p class="p-skill">FRONT-END</p>
                                    <div class="colonne-skill">
                                        <div class="row-skill">
                                        <img class="img-logo-skill" src="<?= base_url('public/img/article-right/contact/html.svg'); ?>" alt="HTML">
                                            <p class="txt-skill">HTML</p>
                                        </div>
                                        <div class="row-skill">
                                        <img class="img-logo-skill" src="<?= base_url('public/img/article-right/contact/css.svg'); ?>" alt="CSS">

                                            <p class="txt-skill">CSS</p>
                                        </div>
                                        <div class="row-skill">
                                        <img class="img-logo-skill" src="<?= base_url('public/img/article-right/contact/js.svg'); ?>" alt="JavaScript">

                                            <p class="txt-skill">JS</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="bloc-div2">
                                    <p class="p-skill">BACK-END</p>
                                    <div class="colonne-skill">
                                        <div class="row-skill">
                                        <img class="img-logo-skill" src="<?= base_url('public/img/article-right/contact/php.svg'); ?>" alt="PHP">

                                            <p class="txt-skill">PHP</p>
                                        </div>
                                        <div class="row-skill">
                                        <img class="img-logo-skill database" src="<?= base_url('public/img/article-right/contact/mysql.svg'); ?>" alt="MySQL">

                                            <p class="txt-skill">MYSQL</p>
                                        </div>
                                        <div class="row-skill">
                                        <img class="img-logo-skill icon-skill" src="<?= base_url('public/img/article-right/contact/codeigniter.svg'); ?>" alt="CodeIgniter">

                                            <p class="txt-skill">CodeIgniter</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="bloc2">
                                <p class="title-skill center-skill fr">Développement App</p>
                                <p class="title-skill center-skill en" style="display:none;">App development</p>
                                <p class="p-skill fr">Android / Logiciel</p>
                                <p class="p-skill en" style="display:none;">Android / Software</p>
                                <div class="colonne-skill separation-skill">
                                    <div class="row-skill">
                                    <img class="img-logo-skill icon-skill" src="<?= base_url('public/img/article-right/contact/python.svg'); ?>" alt="Python">

                                        <p class="txt-skill">PYTHON</p>
                                    </div>
                                </div>
                                <div class="colonne-skill separation-skill">
                                    <div class="row-skill">
                                    <img class="img-logo-skill icon-skill" src="<?= base_url('public/img/article-right/contact/java.svg'); ?>" alt="Java">

                                        <p class="txt-skill">JAVA → Android Studio</p>
                                    </div>
                                </div>
                                <div class="colonne-skill separation-skill">
                                    <div class="row-skill">
                                    <img class="img-logo-skill icon-skill" src="<?= base_url('public/img/article-right/contact/api.svg'); ?>" alt="API">
                                        <p class="txt-skill">WEB SERVICE-> API REST</p>
                                    </div>
                                </div>
                            </div>
