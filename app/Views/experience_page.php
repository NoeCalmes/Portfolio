                ...
                <div class="article-right">
                    ...
                    <div class="small-navbar">
                        <ul>
                            ...
                            <!--    <a href="?category=stage" type="button">
                    <li class="dark rizoto fr">Stage</li>
                    <li class="dark en" style="display:none;">Internship</li>
                </a> -->

                            <a href="?category=web" type="button">
                                <li class="dark rizoto lop ris fr">Projet Web</li>
                                <li class="dark lop en" style="display:none;">Web project</li>
                            </a>

                            <a href="?category=ecom" type="button">
                                <li class="dark rizoto fr">Projet E-commerce</li>
                                <li class="dark en" style="display:none;">E-commerce project</li>
                            </a>
                        </ul>
                    </div>
                    ...
                    <div class="container" id="all-card">
                        ...
                        <div class="left-card">
                            <?php if ($showAllCards || $showWebCard): ?>
                                <a href="<?= base_url('autoecole')  ?>" type="button">
                                    <div class="card1" id="web-card">
                                        <img class="img-card" src="public/img/article-right/work/autoecole.svg"
                                            alt="Création Site Vitrine">
                                        <p class="fr">Création Site Vitrine</p>
                                        <p class="en" style="display:none;">Creation of a Showcase Website</p>
                                        <h1 class="fr">L'Auto Ecole Va-là</h1>
                                        <h1 class="en" style="display:none;">Site Auto Ecole Va-là</h1>
                                    </div>
                                </a>
                            <?php endif; ?>

                            <?php if ($showAllCards || $showWebCard): ?>
                                <a href="<?= base_url('Aquiestcenumero')?>" type="button">
                                    <div class="card3" id="app-card">
                                        <img class="img-card" src="public/img/article-right/work/aquiestcenumero.svg"
                                            alt="Service en ligne">
                                        <p class="fr">Service en ligne</p>
                                        <p class="en" style="display:none;">Online Number Lookup Service</p>
                                        <h1 class="fr">A qui est ce Numero ?</h1>
                                        <h1 class="en" style="display:none;">Site A-qui-est-ce-numero ?</h1>
                                    </div>
                                </a>
                            <?php endif; ?>

                            <?php if ($showAllCards || $showCmsCard): ?>
                                <a href="<?= base_url('avisimo')?>" type="button">
                                    <div class="card2" id="cms-card">
                                        <img src="public/img/article-right/work/avisimoo.svg" alt="E-commerce">
                                        <p class="fr">Site E-commerce</p>
                                        <p class="en" style="display:none;">E-commerce Website</p>
                                        <h1>Avisimo</h1>
                                    </div>
                                </a>
                            <?php endif; ?>
                        ...
                        <div class="right-card">
                            <a href="<?= base_url('concretesecurity')?>" type="button">
                                <?php if ($showAllCards || $showWebCard): ?>
                                    <div class="cardone" id="web-card">
                                        <img src="public/img/article-right/work/concretesecurity.svg" alt="Application Web">
                                        <p class="fr">Application Web</p>
                                        <p class="en" style="display:none;">Web App</p>
                                        <h1 class="fr">Projet ConcreteSecurity</h1>
                                        <h1 class="en" style="display:none;">Concretesecurity Project</h1>
                                    </div>
                                <?php endif; ?>
                            </a>
                            <a href="<?= base_url('experience')?>" type="button">
                                <?php if ($showAllCards || $showAppCard): ?>
                                    <div class="cardtwo" id="app-card">
                                        <img src="public/img/article-right/work/construction.svg" alt="Placeholder">
                                        <p class="fr">???????</p>
