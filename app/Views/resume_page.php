            ...
            <div class="article2 resume">
                <div class="article-right">
                    ...
                    <div class="initial">
                        <div class="title-categ">
                            ...
                            <img src="public/img/article-right/resume/education.svg" alt="">
                            <h1 class="dark loup">Education</h1>

                            <!--  <img src="img/article-right/resume/experience.svg" alt="">
                <h1 class="dark">Experience</h1> -->
                        ...
                        <div class="card-desc">
                            ...
                            <div class="card">
                                <p>2020-2022</p>
                                <h1 class="fr">Baccalauréat</h1>
                                <h1 class="en" style="display:none;">High school diploma</h1>
                                <h2 class="fr">Filière STI2D</h2>
                                <h2 class="en" style="display:none;">Technological Diploma</h2>
                            </div>


                            <div class="card">
                                <p>2024-2025</p>
                                <h1 class="fr">Bachelor - IPSSI</h1>
                                <h1 class="en" style="display:none;">Bachelor - IPSSI</h1>
                                <h2 class="fr">Développement full stack et DevOps</h2>
                                <h2 class="en" style="display:none;">Développement full stack et DevOps</h2>
                            </div>


                            <div class="card">
                                <p>2023-2024</p>
                                <h1 class="fr">Lycée Emile-Peytavin</h1>
                                <h1 class="en" style="display:none;">High school Emile-Peytavin</h1>
                            ...
                            <div class="card">
                                ...
                                <h2 class="fr">Autodidact</h2>
                                <h2 class="en" style="display:none;">Autodidact</h2>
                            </div>

                        </div>
                    </div>

                    <div class="mobile-parcours ">
                ...
                <h1 class="dark">Exprience</h1> -->
                    ...
                    <div class="article-end">
                        ...
                        <div class="left-end">
                            <h1 class="fr skills-title dark fr">Centre d'Intérêts
                            </h1>
                            <h1 class="skills-title dark en" style="display:none;">Center of interest</h1>
                        ...
                        <div class="right-end">
                            <h1 class="skills-title dark fr">Divers</h1>
                            <h1 class="skills-title dark en" style="display:none; ">Miscellaneous</h1>

                            <div class="work">
                                <p class="fr">Entrepreneuriat</p>
                                <p class="en" style="display:none;">Entrepreneurship</p>
                                <p class="fr">E-commerce</p>
                                <p class="en" style="display:none;">E-commerce</p>
                                <p class="fr">Nouvelles technologies|IA</p>
                                <p class="en troisy" style="display:none;">New technologies|AI</p>
                                <p class="fr">Jeux Vidéos</p>
                                <p class="en" style="display:none;">Video games</p>
                            </div>
