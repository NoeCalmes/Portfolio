...
<body>
    ...
    <article>
        <div class="container">
            ...
            <div class="article2 concrete">
                <div class="article-right">
                    <div class="about">
                        <div class="centrer-d">
                            <h1 class="dark fr lop">Application Web</h1>
                            <h1 class="dark en lop" style="display:none;">Web App</h1>
                            <p class="soustitre-p dark">ConcreteSecurity</p>
                    ...
                    <div class="iframe-container">
                        <div class="bloc1-avisimo">
                            <img class="avisimo-logo concrete" src="public/img/article-right/work/concrete/logo.png" alt="">
                            <h2 class="fr">← Projet fin d'année BTS SIO</span></h2>
                            <h2 class="en" style="display:none;">← End-of-Year Project for BTS SIO</span></h2>
                        </div>
                        <div class="bloc2-avisimo">
                            <div class="bloc-text1">
                                <h1 class="fr">Présentation du Projet
                                </h1>
                                <h1 class="en" style="display:none;">Project Presentations
                                </h1>
                                <p class="fr">Le projet "Concrete Security" vise à moderniser les processus d'une
                                    entreprise
                                    fictive spécialisée dans la surveillance et la sécurité. Actuellement, cette
                                    entreprise gère ses services de manière manuelle, ce qui entraîne des inefficacités
                                    et des retards dans le traitement des demandes des clients.
                                </p>
                                <p class="en" style="display:none;">The 'Concrete Security' project aims to modernize
                                    the processes of a fictional company specializing in surveillance and security.
                                    Currently, this company manages its services manually, leading to inefficiencies and
                                    delays in processing client requests.
                                </p>
                            </div>
                            <img src="public/img/article-right/work/concrete/image-concrete.png" class="video-avisimo" alt="">
                        </div>
                        <!--  <p class="google-avis">*Avisimo a été créé avant l'apparition des QR Code avis Google
                            développés
                            par Google.</p> -->
                        <div class="bloc3-avisimo">
                            <h1 class="h1-avisimo fr">Fonctionnement :</h1>
                            <h1 class="h1-avisimo en " style="display:none;">Operation:</h1>
                            <p class="p-avisimo fr">L'objectif principal est de développer un système informatisé qui
                                permettra de gérer efficacement les demandes de services en ligne. Les clients pourront
                                soumettre leurs demandes via un formulaire en ligne, les personnaliser selon leurs
                                besoins, et suivre l'évolution de leurs contrats. Les administrateurs auront accès à un
                                tableau de bord pour gérer les demandes et attribuer les contrats aux employés
                                qualifiés.
                            </p>
                            <p class="p-avisimo en" style="display:none;">
                                The main objective is to develop a computerized system that will effectively manage
                                online service requests. Clients will be able to submit their requests via an online
                                form, customize them according to their needs, and track the progress of their
                                contracts. Administrators will have access to a dashboard to manage requests and assign
                                contracts to qualified employees.
                            </p>
                            <img src="public/img/article-right/work/concrete/image3-concrete.png" class="video-avisimo" alt="">
                            bt
                            <img src="public/img/article-right/work/concrete/image2-concrete.png"
                                class="video-avisimo photo-concret" alt="">
                        </div>

                        <div class="bloc5-avisimo">
                            <h1 class="h1-avisimo fr">Objectif:
                            </h1>
                            <h1 class="h1-avisimo en" style="display:none;">Objective:
                            </h1>
                            <p class="p-avisimo fr ">Le but du projet est d'améliorer la réactivité, la précision et
                                la satisfaction des clients en passant d'une gestion manuelle à une gestion numérique.
                                Cela permettra à l'entreprise de répondre de manière plus efficace aux besoins de ses
                                clients et de rester compétitive sur le marché.
                            </p>
                            <p class="p-avisimo en" style="display:none;">
                                The aim of the project is to enhance customer responsiveness, accuracy, and satisfaction
                                by
                                transitioning from manual to digital management. This will enable the company to more
                                effectively meet the needs of its customers and remain competitive in the market.
                            </p>
                        </div>


                        <div class="bloc2-avisimo">
                            <h1 class="h1-avisimo fr" style="text-decoration:underline;">Modèle Conceptuel de Donnée:
                            </h1>
                            <h1 class="h1-avisimo en" style="text-decoration:underline; display:none;">Conceptual Data
                                Model:</h1>

                            <img class="img-web" src="public/img/article-right/work/concrete/mcd.png" alt="">
                            <div class="bloc-text1">
                                <h1 class="fr">Conclusion :
                                </h1>
                                <h1 class="en" style="display:none;">Conclusion :
                                </h1>
                                <p class="fr">Le projet "Concrete Security" représente une étape importante dans la
                                    transformation
                                    numérique de l'entreprise. En informatisant ses processus, l'entreprise pourra
                                    accroître son efficacité opérationnelle et offrir un meilleur service à ses clients.
                                </p>
                                <p class="en" style="display:none;">The "Concrete Security" project represents a
                                    significant step in the digital transformation of the company. By digitizing its
                                    processes, the company will be able to increase its operational efficiency and
                                    provide better service to its clients.
                                </p>
                            </div>

                        </div>
                        <div class="bloc5-avisimo github-bloc">
                            <h1 class="h1-avisimo fr">Ressource Open Source:</h1>
                            <h1 class="h1-avisimo en" style="display:none;">Open Source Resource:</h1>
                            <a href="https://github.com/NoeCalmes/ConcreteSecurity" class="p-avisimo github-projet">Github
                        </div>
                    </div>
                </div>
            </div>
