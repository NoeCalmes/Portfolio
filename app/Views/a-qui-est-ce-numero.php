...
<head>
    ...
    <title>A-qui-est-ce-numero?</title>
        ...
        <div class="container">
            ...
            <div class="article2">
                <div class="article-right">
                    ...
                    <div class="about">
                        <div class="centrer-d">
                            <h1 class="dark fr lop">Service en ligne</h1>
                            <h1 class="dark en lop" style="display:none;">Online Service</h1>
                            <p class="soustitre-p dark">A qui est ce numero ?</p>
                    ...
                    <div class="iframe-container">
                        <div class="bloc1-avisimo">
                            ...
                            <img class="avisimo-logo numero-logo"
                                src="public/img/article-right/work/numero/logo-aquiestcenumero.svg" alt="">
                            <h2 class="fr">← Stage en Entreprise - BTS SIO 2<sup> ème</sup> Année</h2>
                            <h2 class="en" style="display:none;">← Internship in a Company - BTS SIO 2<sup>nd</sup> Year
                            </h2>
                        </div>
                        <div class="bloc2-avisimo">
                            <div class="bloc-text1">
                                <h1 class="fr">Plateforme de Signalement et Évaluation des Numéros de Téléphone
                                </h1>
                                <h1 class="en" style="display:none;">Phone Number Reporting and Evaluation Platform
                                </h1>
                                <h2 class="fr">Objectif:</h2>
                                <h2 class="en" style="display:none;">Objective:</h2>
                                <p class="fr">Développer une plateforme interactive permettant aux utilisateurs de
                                    signaler et
                                    d'évaluer des numéros de téléphone, avec pour objectif de fournir une base de
                                    données fiable et exhaustive pour aider les utilisateurs à identifier les appels et
                                    messages
                                    indésirables ou utiles
                                </p>
                                <p class="en" style="display:none;">Develop an interactive platform enabling users to
                                    report and evaluate phone numbers, aiming to provide a reliable and comprehensive
                                    database to assist users in identifying unwanted or useful calls and messages.</p>
                            </div>
                            <div class="">
                                <iframe class=" custom-iframe" src="https://a-qui-est-ce-numero.com/"></iframe>
                            </div>
                            <a href="https://a-qui-est-ce-numero.com/" class="site-numero">Le site :
                                <span>a-qui-est-ce-numero.com</span></a>
                        </div>
                        <!--  <p class="google-avis">*Avisimo a été créé avant l'apparition des QR Code avis Google développés
                            par Google.</p> -->
                        <div class="bloc3-avisimo">
                            <h1 class="h1-avisimo">Description:</h1>
                            <p class="p-avisimo fr">A-qui-est-ce-numéro ? est une plateforme conçue pour permettre aux
                                utilisateurs de signaler et d'évaluer les numéros de téléphone associés à des activités
                                indésirables ou utiles. Le projet vise à offrir une interface intuitive et conviviale
                                permettant aux utilisateurs de saisir des numéros de téléphone, de consulter les avis
                                associés, et de contribuer à l'enrichissement de la base de données.
                            </p>
                            <p class="p-avisimo en" style="display:none;">"A-qui-est-ce-numéro?" is a platform designed
                                to allow users to report and evaluate phone numbers associated with unwanted or useful
                                activities. The project aims to provide an intuitive and user-friendly interface for
                                users to enter phone numbers, view associated reviews, and contribute to enriching the
                                database.
                            </p>
                        </div>
                        <div class="bloc4-avisimo">
                            <h1 class="h1-avisimo fr">Compétences Acquises:</h1>
                            <h1 class="h1-avisimo en" style="display:none;">Skills Acquired:</h1>
                            <p class="p-avisimo fr ">• Gestion de projet de A à Z, incluant la conception, le
                                développement
                                et
                                le déploiement du site web.<br>
                                • Maîtrise des langages de programmation web tels que PHP et JavaScript, ainsi que des
                                Frameworks comme CodeIgniter et l'ORM Eloquente.<br>
                                • Manipulation de bases de données MySQL et utilisation d'outils de gestion comme
                                PhpMyAdmin.<br>
                                • Développement de compétences en communication et travail à distance, avec un suivi
                                quotidien assuré par une équipe de développeurs.</p>
                            <p class="p-avisimo en">• Project management from A to Z, including design, development, and
                                deployment of the website.<br>
                                • Proficiency in web programming languages such as PHP and JavaScript, as well as
                                frameworks like CodeIgniter and the Eloquente ORM.<br>
                                • Database manipulation with MySQL and utilization of management tools like
                                PhpMyAdmin.<br>
                                • Development of communication skills and remote work, with daily monitoring provided by
                                a team of developers.</p>
                        </div>
                        <div class="bloc5-avisimo blocline">
                            <h1 class="h1-avisimo">Bilan:
                            </h1>
                            <p class="p-avisimo fr">Bilan:
                                A-qui-est-ce-numero.com est une plateforme opérationnelle offrant une expérience
                                utilisateur optimale
                                pour signaler et évaluer les numéros de téléphone. Les compétences acquises lors de ce
                                projet ont été précieuses pour mon développement professionnel, en particulier dans les
                                domaines du développement web et de la gestion de projet.
                            </p>
                            <p class="p-avisimo en" style="display:none;">
                                Summary: A-qui-est-ce-numero.com is an operational platform providing an optimal user
                                experience for reporting and evaluating phone numbers. The skills acquired during this
                                project have been invaluable for my professional development, especially in the areas of
                                web development and project management
                            </p>
                        </div>
                        <div class="line-autoecole"></div>
                        <div class="bloc4-avisimo">
                            <div class="bloc-text1">
                                <h1 class="fr">Diaporama d'Evolution du Site Web
                                </h1>
                                <h1 class="en" style="display:none;">Slideshow of Website Evolution
                                </h1>
                                <p class="fr">Ces diapositives illustrent les différentes étapes du processus de conception et de
                                    développement, mettant en avant les choix de design, l'intégration de
                                    fonctionnalités et l'optimisation de l'expérience utilisateur.
                                </p>
                                <p class="en" style="display:none;">
                                    These slides illustrate the various stages of the design and development process,
                                    highlighting design choices, feature integration, and user experience optimization.
                                </p>
                            </div>
                            <div class="img-webb" style="width: 100%;">
                                <div style="position: relative; padding-bottom: 56.25%; padding-top: 0; height: 0;">
                                    <iframe title="Présentation minimaliste" frameborder="0" width="1200" height="675"
                                        style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"
                                        src="https://view.genial.ly/65f1f2024f8e2d0014643e9e" type="text/html"
