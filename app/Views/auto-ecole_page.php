                ...
                <div class="article-right">
                    ...
                    <div class="about">
                        <div class="centrer-d">
                            ...
                            <h1 class="dark en lop" style="display:none;">Website</h1>
                    ...
                    <div class="iframe-container">
                        <div class="bloc1-avisimo">
                            <img class="avisimo-logo vala-auto" src="public/img/article-right/work/autoecole/logo.svg" alt="">
                            <h2 class="fr">← Stage en Entreprise - BTS SIO 1<sup> ère</sup> Année</h2>
                            <h2 class="en" style="display:none;">← Internship in a Company - BTS SIO 1<sup>st</sup> Year
                            </h2>
                        </div>
                        <div class="bloc2-avisimo">
                            <div class="bloc-text1">
                                <h1 class="fr">Objectif:
                                </h1>
                                <h1 class="en" style="display:none;">Objective:
                                </h1>
                                <p class="fr">Développement d'un site web vitrine pour l'auto-école Va-là, visant à
                                    améliorer sa
                                    visibilité en ligne et faciliter la communication avec ses clients.
                                </p>
                                <p class="en" style="display:none;">Development of a showcase website for the driving
                                    school "Va-là," aiming to enhance
                                    its online visibility and facilitate communication with its clients.</p>
                            </div>
                            <div class="">
                                <iframe class="custom-iframe" src="https://www.autoecole-vala.fr/"></iframe>
                            </div>
                            <a href="https://www.autoecole-vala.fr/" class="site-auto fr">Le site :
                                <span>autoecole-vala.fr</span></a>
                            <a style="display:none;" href="https://www.autoecole-vala.fr/" class="site-auto en dark">Website
                                :
                                <span>autoecole-vala.fr</span></a>
                        </div>
                        ...
                        <div class="bloc3-avisimo">
                            <h1 class="h1-avisimo fr">Déroulement:</h1>
                            <h1 class="h1-avisimo en" style="display:none;">Process:</h1>
                            <p class="p-avisimo fr ">• Priorité donnée à l'expérience utilisateur sur les appareils
                                mobiles
                                (méthodologie "Mobile First").
                                <br>• Conception de la maquette du site à l'aide de l'outil Figma.
                                <br>• Développement du site en utilisant HTML5, CSS, JavaScript et PHP.
                                <br>• Intégration d'une API pour afficher les avis Google de l'auto-école.
                                <br>• Choix d'un hébergeur web fiable pour la mise en ligne du site.
                            </p>
                            <p class="p-avisimo en" style="display:none;">
                                • Priority given to user experience on mobile devices (Mobile First methodology).
                                <br>• Design of the website mockup using the Figma tool.
                                <br>• Development of the website using HTML5, CSS, JavaScript, and PHP.
                                <br>• Integration of an API to display Google reviews of the driving school.
                                <br>• Selection of a reliable web hosting service for the website deployment.
                            </p>
                        </div>
                        <div class="bloc4-avisimo">
                            <h1 class="h1-avisimo fr ">Résultats:</h1>
                            <h1 class="h1-avisimo en" style="display:none;">
                                Results:</h1>
                            <p class="p-avisimo fr ">• Site web entièrement "responsive", offrant une expérience fluide
                                sur
                                tous les appareils.<br>
                                • Amélioration de la visibilité en ligne de l'auto-école et optimisation de l'expérience
                                utilisateur.<br>
                                • Acquisition de compétences pratiques en développement web et gestion de projet.
                            </p>
                            <p class="p-avisimo en" style="display:none;">
                                • Fully "responsive" website, providing a smooth experience on all devices.
                                <br>• Improved online visibility of the driving school and optimization of the user
                                experience.
                                <br>• Acquisition of practical skills in web development and project management.
                            </p>
                        </div>
                        <div class="bloc5-avisimo blocline">
                            <h1 class="h1-avisimo">Bilan:
                            </h1>
                            <p class="p-avisimo fr">Une opportunité enrichissante pour développer mes compétences en
                                programmation web et acquérir une expérience concrète dans le domaine professionnel.
                                J'ai atteint mes objectifs et contribué positivement au projet de l'auto-école Va-là.
                            </p>
                            <p class="p-avisimo en" style="display:none;">
                                An enriching opportunity to develop my web programming skills and gain practical
                                experience
                                in the professional field. I have achieved my goals and made a positive contribution to
                                the
                                Va-là driving school project. </p>
                        </div>
                        ...
                        <div class="bloc4-avisimo">
                            <div class="bloc-text1">
                                ...
                                <h1 class="en" style="display:none;">Diaporama
                                    Slideshow of Website Evolution </h1>
                            ...
                            <div class="img-webb" style="width: 100%;">
                                <div style="position: relative; padding-bottom: 56.25%; padding-top: 0; height: 0;">
                                    <iframe title="Stage 2eme année" frameborder="0" width="1200" height="675"
                                        style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"
                                        src="https://view.genial.ly/65dc65b4d01550001563929a" type="text/html"
